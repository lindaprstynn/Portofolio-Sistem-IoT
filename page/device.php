              ...
              <form method="POST" action="?page=<?php echo $page ?>"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="serial_number" placeholder="*tidak boleh sama" required>
                  </div>
                  <div class="form-group">
              ...
              <form method="POST" action="?page=<?php echo $page ?>"> 
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="serial_number" value="<?php echo $data['serial_number'] ?>" placeholder="*tidak boleh sama" required>
                  </div>
                  <div class="form-group">
                    <label>Jenis Kontroler</label>
